/**
 * React element/type `$$typeof` marker values.
 *
 * These are the numeric values React 17 actually stores in `$$typeof`, used
 * by the DevTools backend when inspecting fibers. Do not change these.
 *
 * Ported from `react-devtools-shared/src/backend/ReactSymbols.js` (React 17).
 *
 * @module ReactSymbols
