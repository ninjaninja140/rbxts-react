/**
 * Side-effect flags stored on a fiber.
 *
 * Upstream: `packages/react-reconciler/src/ReactFiberFlags.js`
 *
...
// Don't change these two values. They're used by React DevTools.
...
// e.g. a fiber uses a passive effect (even if there are no updates on this
// particular render).
...
// without traversing the entire tree after every commit.
